...
export default function Pricing({ data }: PriceProps) {
  return (
    <section className="py-1 dark:bg-black dark:text-gray-100 m:py-1 lg:py-1">
      <div className="container px-4 mx-auto ">
        ...
        <div className="flex flex-wrap items-stretch max-w-12xl mx-auto">
          {data.plans.map((plan: Plan) => (
            <div
              key={plan.id}
              className="w-full p-4 mb-8  sm:mx-40 lg:mx-0 lg:w-1/4 lg:mb-0"
            >
              <div
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="text-1xl">{plan.description}</div>
                ...
                ></p>
                {/* <div><Markdown>{plan.body}</Markdown></div> */}
                <ul
