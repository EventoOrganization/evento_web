...
export default function RsvpFormTab() {
  ...
  return (
    <>
      <div>
        Create your personalized RSVP form for your guests to fill in.
      </div>
      ...
      <div className="my-10 flex items-center">
        <Link className="text-dark" onClick={() => openModal('AddAnotherField')}>
          <div className="rounded-full bg-gradient-to-tr from-pink-500 to-blue-500 w-6 h-6 p-5 flex items-center justify-center text-white text-3xl font-bold mr-3">+</div>
