import { RadioGroup, Radio, DatePicker, TimeInput, Modal, ModalContent, ModalBody, Textarea, Avatar, Button, Input, Image } from '@nextui-org/react'
  ...
  return (
    <>
      <div>
        ...
        <div className="my-3">
          <h3 className="text-md font-bold mb-1">Upload Video <span className="text-gray-400 text-xs">(Optional)</span></h3>
          <label htmlFor="product_video" className="flex flex-col items-center justify-center rounded-lg h-64 w-100 px-6 text-lg focus:outline-none focus:ring focus:border-blue-300 cursor-pointer bg-white">
            <VideoIcon />
            <span className="mt-2 text-base leading-normal text-blue-500 font-bold">Upload Video</span>
        ...
        <div className="my-3">
          ...
          <div className="flex overflow-x-auto space-x-8 w-full">
            <section className="flex-shrink-0">
              <label htmlFor="product_image" className="flex flex-col items-center justify-center rounded-lg h-24 w-32 px-6 text-lg focus:outline-none focus:ring focus:border-blue-300 cursor-pointer bg-white">
                <CameraIcon />
        ...
        <div className="my-3">
          <h1 className="text-xl font-bold mb-1 text-fuchsia-700">Add Co-Host (optional)</h1>
          <div className="flex overflow-x-auto space-x-8 w-full">
            <section className="flex-shrink-0">
              <div className="flex flex-col items-center justify-center space-y-2">
                <Avatar
                  ...
                  className="w-20 h-20"
                />
                <span className="text-sm font-bold text-center">Jully Marker</span>
              </div>
            </section>
            <section className="flex-shrink-0">
              <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <section className="flex-shrink-0">
              <div className="flex flex-col items-center justify-center space-y-2">
                <Link className="ml-2" onClick={() => openModal('AddGuests')} href={''}>
                  <div className="w-20 h-20 flex items-center justify-center rounded-full border border-gray-900 font-bold">
                    <PlusAddUserIcon />
                  </div>
                </Link>
                <span className="text-sm font-bold text-center">Add People</span>
              </div>
            </section>
          </div>
        </div>
