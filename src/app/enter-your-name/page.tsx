    ...
    <>
      <div className="bg-white h-screen">
        <div className="p-9 w-full max-w-lg mx-auto">
          ...
          <div className="text-3xl font-bold mt-8">Enter your name</div>
          ...
          <div className="mt-10">
            <Input placeholder="First name" size="lg" name="firstName" />
          </div>
          <div className="mt-6">
            <Input placeholder="Last name" size="lg" name="lastName" />
          </div>
