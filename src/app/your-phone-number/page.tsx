...
import { Input, Link, Autocomplete, AutocompleteItem, Avatar } from "@nextui-org/react";
        ...
        <div className="p-9 w-full max-w-lg mx-auto">
          ...
          <div className="mt-16 items-center flex justify-center bg-default-100 rounded-lg">
            ...
            >
              ...
              <AutocompleteItem
                key="Viet Nam"
                startContent={<Avatar alt="Viet Nam" className="w-6 h-6" src="https://flagcdn.com/vn.svg" />}
              >
                Viet Nam
              </AutocompleteItem>
            </Autocomplete>
